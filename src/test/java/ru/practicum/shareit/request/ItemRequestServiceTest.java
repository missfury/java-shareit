...
public class ItemRequestServiceTest {
    ...
    public void addRequestTest() {
        ...
        ItemRequestDto actualNewRequest = itemRequestService.addRequest(user.getId(), itemRequestShortDto);
    ...
    void addRequestWithWrongUserIdTest() {
        ...
        assertThrows(NotFoundException.class, () -> itemRequestService.addRequest(userId, dtoShort));
    ...
    @Test
    void getRequestByIdWithWrongUserTest() {
        Long userId = 999L;
        Long requestId = 1L;
        when(userRepository.existsById(anyLong())).thenReturn(false);
    ...
    @Test
    void getRequestByIdWithWrongRequestTest() {
        Long userId = user.getId();
        Long requestId = 999L;
    ...
    @Test
    void getAllByRequesterWithWrongUserIdTest() {
        Long userId = 999L;
        when(userRepository.existsById(anyLong())).thenReturn(false);
        assertThrows(NotFoundException.class, () ->
        itemRequestService.getAllRequestsByRequester(userId, 0, 10));
