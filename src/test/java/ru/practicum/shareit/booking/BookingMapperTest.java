...
import static ru.practicum.shareit.booking.BookingMapper.bookToItem;
...
class BookingMapperTest {
    ...
    @Test
    void bookingToItemTest() {
        BookingItemDto bookingItemDto = bookToItem(booking);
